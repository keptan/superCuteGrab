...
superCuteGrab: superCuteGrab.o  hashDB.o window.o image.o thumbDB.o filetypes.o $(TSOBN)
	$(CC) ./src/obj/superCuteGrab.o ./src/obj/hashDB.o ./src/obj/thumbDB.o ./src/obj/fileMd5.o  ./src/obj/window.o ./src/obj/image.o ./src/obj/filetypes.o -lstdc++fs  -lcrypto -lssl $(TSOB) $(GTKL) $(GTKC)  $(TSLIB)  -o cuteGrab 
