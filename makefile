...
superCuteGrab: $(OBJ)superCuteGrab.o  $(OBJ)cskill_instance.o $(OBJ)collectionMan.o $(OBJ)hashDB.o $(OBJ)window.o $(OBJ)tagSet.o $(OBJ)tag.o $(OBJ)image.o $(OBJ)thumbDB.o $(OBJ)tagDB.o $(OBJ)filetypes.o $(OBJ)scoreDB.o $(OBJ)fileMd5.o $(OBJ)compMan.o $(TSOBN)
	$(CC) ./src/obj/superCuteGrab.o ./src/obj/cskill_instance.o ./src/obj/hashDB.o ./src/obj/collectionMan.o ./src/obj/thumbDB.o ./src/obj/scoreDB.o ./src/obj/fileMd5.o  ./src/obj/window.o ./src/obj/image.o ./src/obj/tag.o ./src/obj/tagSet.o ./src/obj/tagDB.o ./src/obj/filetypes.o ./src/obj/compMan.o -lstdc++fs  -lcrypto -lssl $(TSOB) $(GTKL) $(GTKC)  $(TSLIB)  -o cuteGrab 
...
$(OBJ)window.o: ./src/graphics/window.cpp ./src/graphics/window.h $(OBJ)collectionMan.o $(OBJ)thumbDB.o $(OBJ)image.o
